    ...
    <div className="relative h-[85vh] w-full overflow-hidden bg-nene-dark flex flex-col items-center justify-center text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <video
          ...
          poster="https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?q=80&w=2070&auto=format&fit=crop"
        >
          {/* New Reliable Video Source (Concert Crowd) */}
          <source
      ...
      <div className="relative z-20 w-full max-w-4xl px-4 flex flex-col items-center text-center space-y-8">
        ...
        >
            ...
            <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-2 flex items-center">
                ...
                <input 
                    type="text" 
                    className="w-full bg-transparent text-white text-lg px-4 py-3 outline-none placeholder-gray-300"
                    placeholder={PLACEHOLDERS[placeholderIndex]}
                />
                <button className="bg-white text-black font-bold py-3 px-8 rounded-xl hover:bg-gray-200 transition">
                    Find
                </button>
            </div>
        </motion.div>
